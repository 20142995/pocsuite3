# encoding: utf-8
# Author    : Sma11stu
# Datetime  : 2021/4/4 21:36
# Product   : PyCharm
# Project   : pocsuite3
# File      : jetty_6_x_xss.py
# explain   : 文件说明
...
class DemoPOC(POCBase):
    ...
    def _verify(self):
        ...
        verify_payload = "/test/" + xss_payload
        ...
        try:
            ...
            if xss_payload in resp.text and resp.status_code == 404:
                result['VerifyInfo'] = {}
