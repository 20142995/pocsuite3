...
class DemoPOC(POCBase):
    ...
    name = "魅课OM视频会议系统"  # PoC 名称
    appPowerLink = ""  # 漏洞厂商主页地址
    appName = "文件包含"  # 漏洞应用名称
    appVersion = "魅课OM视频会议系统"  # 漏洞影响版本
    ...
    desc = """
        ...
        """  # 漏洞简要描述
    pocDesc = """
            fofa：app="OMEETING-OM视频会议"
            pocsuite -r OMEETING-OM视频会议.py -f url.txt
        """  # POC用法描述
    ...
    def _check(self):
        ...
        try:
            ...
            if 'support' in response.text and response.status_code == 200:
